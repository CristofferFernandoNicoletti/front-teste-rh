...
export function Header() {
  ...
  return (
    <div>
      ...
      {/* Menu Mobile */}
      <div className={`lg:hidden fixed inset-0 bg-white z-40 transition-transform duration-300 ease-in-out transform ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="pt-24 px-6">
          <nav className="flex flex-col gap-4">
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-gray-400">Empresa</h3>
              <div className="flex flex-col gap-4">
                <Link href="https://site-agex.vercel.app/quem-somos" className="text-gray-800">
                  Quem somos
                </Link>
                <a href="https://www.agex.com.br/trabalhe" target="_blank" rel="noopener noreferrer" className="text-gray-800">
                  Trabalhe conosco
                </a>
                <Link href="https://site-agex.vercel.app/qualidade" className="text-gray-800">
                  Qualidade
                </Link>
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="flex flex-col gap-4">
                <Link href="/seja-cliente" className="text-gray-800">
                  Seja cliente
                </Link>
                <Link href="/atendimento" className="text-gray-800">
                  Fale conosco
